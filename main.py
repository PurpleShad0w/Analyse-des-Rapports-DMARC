...
path_default = "home/shared/DMARC/altair.ac6.fr/"
...
def gather_rua(path_mail, path_report, path_attachment):
...
def gather_ruf(path_mail, path_report, path_attachment):
